        ...
        <div class="scrollable-container">
            <div class="page-center">
                <?php foreach ($query_one as $rs) { ?>
                    <?php if (!empty($rs->p_cdc_bnry_rank)): ?>
                        <div class="bg-personnel-s">
                            <div class="rounded-image-s">
                                <?php if (!empty($rs->p_cdc_bnry_img)): ?>
                                    <img src="<?php echo base_url('docs/img/' . $rs->p_cdc_bnry_img); ?>" width="100%"
                                        height="100%">
                                <?php else: ?>
                        ...
                        <div class="mt-3 center-center">
                            <span class="font-p-name">
                                <?php echo !empty($rs->p_cdc_bnry_name) ? $rs->p_cdc_bnry_name : 'ว่าง'; ?>
                            </span>
                            <span class="font-p-detail "><?= $rs->p_cdc_bnry_rank; ?></span>
