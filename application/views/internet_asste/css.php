<style>
    ...
    .bg-header {
        /* The image used */
        background-image: url('<?php echo base_url("docs/intranet/t.navbar-intranet1.png"); ?>');
    ...
    .welcome {
        background-image: url('<?php echo base_url("docs/intranet/t.welcome1.jpg"); ?>');
        background-size: contain;
        background-repeat: no-repeat;
    ...
    .footer {
        background-image: url('<?php echo base_url("docs/intranet/t.bg-intra-footer1.png"); ?>');
        background-size: contain;
        background-repeat: no-repeat;
        width: 100vw;
        height: 31.8vh;
