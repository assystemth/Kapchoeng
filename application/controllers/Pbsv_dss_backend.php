...
class Pbsv_dss_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($pbsv_dss as $pdf) {
            $pdf->pdf = $this->pbsv_dss_model->list_all_pdf($pdf->pbsv_dss_id);
        }
        foreach ($pbsv_dss as $doc) {
            $doc->doc = $this->pbsv_dss_model->list_all_doc($doc->pbsv_dss_id);
        }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->pbsv_dss_model->del_pdf($pdf_id);
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->pbsv_dss_model->del_doc($doc_id);
    ...
    public function del_pbsv_dss($pbsv_dss_id)
    {
        ...
        $this->pbsv_dss_model->del_pbsv_dss_doc($pbsv_dss_id);
